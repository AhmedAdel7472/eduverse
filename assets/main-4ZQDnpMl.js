...
- For robot_mission: include availableBlocks array and correctSequence array in payload.
- For picture_match: include audioPromptText string and options with emoji fields.
...
`);try{n=new Worker(URL.createObjectURL(new Blob([T])))}catch(M){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",M),null}x(n)}return n}})(),c={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function w(n,t){return t?t(n):n}function f(n){return n!=null}function l(n,t,y){return w(n&&f(n[t])?n[t]:c[t],y)}function d(n){return n<0?0:Math.floor(n)}function _(n,t){return Math.floor(Math.random()*(t-n))+n}function $(n){return parseInt(n,16)}function F(n){return n.map(D)}function D(n){var t=String(n).replace(/[^0-9a-f]/gi,"");return t.length<6&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),{r:$(t.substring(0,2)),g:$(t.substring(2,4)),b:$(t.substring(4,6))}}function b(n){var t=l(n,"origin",Object);return t.x=l(t,"x",Number),t.y=l(t,"y",Number),t}function C(n){n.width=document.documentElement.clientWidth,n.height=document.documentElement.clientHeight}function B(n){var t=n.getBoundingClientRect();n.width=t.width,n.height=t.height}function q(n){var t=document.createElement("canvas");return t.style.position="fixed",t.style.top="0px",t.style.left="0px",t.style.pointerEvents="none",t.style.zIndex=n,t}function N(n,t,y,x,T,M,P,v,A){n.save(),n.translate(t,y),n.rotate(M),n.scale(x,T),n.arc(0,0,1,P,v,A),n.restore()}function Y(n){var t=n.angle*(Math.PI/180),y=n.spread*(Math.PI/180);return{x:n.x,y:n.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:n.startVelocity*.5+Math.random()*n.startVelocity,angle2D:-t+(.5*y-Math.random()*y),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:n.color,shape:n.shape,tick:0,totalTicks:n.ticks,decay:n.decay,drift:n.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:n.gravity*3,ovalScalar:.6,scalar:n.scalar,flat:n.flat}}function J(n,t){t.x+=Math.cos(t.angle2D)*t.velocity+t.drift,t.y+=Math.sin(t.angle2D)*t.velocity+t.gravity,t.velocity*=t.decay,t.flat?(t.wobble=0,t.wobbleX=t.x+10*t.scalar,t.wobbleY=t.y+10*t.scalar,t.tiltSin=0,t.tiltCos=0,t.random=1):(t.wobble+=t.wobbleSpeed,t.wobbleX=t.x+10*t.scalar*Math.cos(t.wobble),t.wobbleY=t.y+10*t.scalar*Math.sin(t.wobble),t.tiltAngle+=.1,t.tiltSin=Math.sin(t.tiltAngle),t.tiltCos=Math.cos(t.tiltAngle),t.random=Math.random()+2);var y=t.tick++/t.totalTicks,x=t.x+t.random*t.tiltCos,T=t.y+t.random*t.tiltSin,M=t.wobbleX+t.random*t.tiltCos,P=t.wobbleY+t.random*t.tiltSin;if(n.fillStyle="rgba("+t.color.r+", "+t.color.g+", "+t.color.b+", "+(1-y)+")",n.beginPath(),s&&t.shape.type==="path"&&typeof t.shape.path=="string"&&Array.isArray(t.shape.matrix))n.fill(ye(t.shape.path,t.shape.matrix,t.x,t.y,Math.abs(M-x)*.1,Math.abs(P-T)*.1,Math.PI/10*t.wobble));else if(t.shape.type==="bitmap"){var v=Math.PI/10*t.wobble,A=Math.abs(M-x)*.1,E=Math.abs(P-T)*.1,O=t.shape.bitmap.width*t.scalar,R=t.shape.bitmap.height*t.scalar,L=new DOMMatrix([Math.cos(v)*A,Math.sin(v)*A,-Math.sin(v)*E,Math.cos(v)*E,t.x,t.y]);L.multiplySelf(new DOMMatrix(t.shape.matrix));var z=n.createPattern(g.transform(t.shape.bitmap),"no-repeat");z.setTransform(L),n.globalAlpha=1-y,n.fillStyle=z,n.fillRect(t.x-O/2,t.y-R/2,O,R),n.globalAlpha=1}else if(t.shape==="circle")n.ellipse?n.ellipse(t.x,t.y,Math.abs(M-x)*t.ovalScalar,Math.abs(P-T)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI):N(n,t.x,t.y,Math.abs(M-x)*t.ovalScalar,Math.abs(P-T)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI);else if(t.shape==="star")for(var I=Math.PI/2*3,Q=4*t.scalar,G=8*t.scalar,H=t.x,V=t.y,K=5,W=Math.PI/K;K--;)H=t.x+Math.cos(I)*G,V=t.y+Math.sin(I)*G,n.lineTo(H,V),I+=W,H=t.x+Math.cos(I)*Q,V=t.y+Math.sin(I)*Q,n.lineTo(H,V),I+=W;else n.moveTo(Math.floor(t.x),Math.floor(t.y)),n.lineTo(Math.floor(t.wobbleX),Math.floor(T)),n.lineTo(Math.floor(M),Math.floor(P)),n.lineTo(Math.floor(x),Math.floor(t.wobbleY));return n.closePath(),n.fill(),t.tick<t.totalTicks}function Z(n,t,y,x,T){var M=t.slice(),P=n.getContext("2d"),v,A,E=h(function(O){function R(){v=A=null,P.clearRect(0,0,x.width,x.height),g.clear(),T(),O()}function L(){o&&!(x.width===a.width&&x.height===a.height)&&(x.width=n.width=a.width,x.height=n.height=a.height),!x.width&&!x.height&&(y(n),x.width=n.width,x.height=n.height),P.clearRect(0,0,x.width,x.height),M=M.filter(function(z){return J(P,z)}),M.length?v=u.frame(L):R()}v=u.frame(L),A=R});return{addFettis:function(O){return M=M.concat(O),E},canvas:n,promise:E,reset:function(){v&&u.cancel(v),A&&A()}}}function ae(n,t){var y=!n,x=!!l(t||{},"resize"),T=!1,M=l(t,"disableForReducedMotion",Boolean),P=r&&!!l(t||{},"useWorker"),v=P?S():null,A=y?C:B,E=n&&v?!!n.__confetti_initialized:!1,O=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,R;function L(I,Q,G){for(var H=l(I,"particleCount",d),V=l(I,"angle",Number),K=l(I,"spread",Number),W=l(I,"startVelocity",Number),Se=l(I,"decay",Number),ke=l(I,"gravity",Number),we=l(I,"drift",Number),le=l(I,"colors",F),_e=l(I,"ticks",Number),ce=l(I,"shapes"),Te=l(I,"scalar"),Me=!!l(I,"flat"),de=b(I),me=H,ie=[],Pe=n.width*de.x,Ae=n.height*de.y;me--;)ie.push(Y({x:Pe,y:Ae,angle:V,spread:K,startVelocity:W,color:le[me%le.length],shape:ce[_(0,ce.length)],ticks:_e,decay:Se,gravity:ke,drift:we,scalar:Te,flat:Me}));return R?R.addFettis(ie):(R=Z(n,ie,A,Q,G),R.promise)}function z(I){var Q=M||l(I,"disableForReducedMotion",Boolean),G=l(I,"zIndex",Number);if(Q&&O)return h(function(W){W()});y&&R?n=R.canvas:y&&!n&&(n=q(G),document.body.appendChild(n)),x&&!E&&A(n);var H={width:n.width,height:n.height};v&&!E&&v.init(n),E=!0,v&&(n.__confetti_initialized=!0);function V(){if(v){var W={getBoundingClientRect:function(){if(!y)return n.getBoundingClientRect()}};A(W),v.postMessage({resize:{width:W.width,height:W.height}});return}H.width=H.height=null}function K(){R=null,x&&(T=!1,e.removeEventListener("resize",V)),y&&n&&(document.body.contains(n)&&document.body.removeChild(n),n=null,E=!1)}return x&&!T&&(T=!0,e.addEventListener("resize",V,!1)),v?v.fire(I,H,K):L(I,H,K)}return z.reset=function(){v&&v.reset(),R&&R.reset()},z}var te;function se(){return te||(te=ae(null,{useWorker:!0,resize:!0})),te}function ye(n,t,y,x,T,M,P){var v=new Path2D(n),A=new Path2D;A.addPath(v,new DOMMatrix(t));var E=new Path2D;return E.addPath(A,new DOMMatrix([Math.cos(P)*T,Math.sin(P)*T,-Math.sin(P)*M,Math.cos(P)*M,y,x])),E}function ve(n){if(!s)throw new Error("path confetti are not supported in this browser");var t,y;typeof n=="string"?t=n:(t=n.path,y=n.matrix);var x=new Path2D(t),T=document.createElement("canvas"),M=T.getContext("2d");if(!y){for(var P=1e3,v=P,A=P,E=0,O=0,R,L,z=0;z<P;z+=2)for(var I=0;I<P;I+=2)M.isPointInPath(x,z,I,"nonzero")&&(v=Math.min(v,z),A=Math.min(A,I),E=Math.max(E,z),O=Math.max(O,I));R=E-v,L=O-A;var Q=10,G=Math.min(Q/R,Q/L);y=[G,0,0,G,-Math.round(R/2+v)*G,-Math.round(L/2+A)*G]}return{type:"path",path:t,matrix:y}}function xe(n){var t,y=1,x="#000000",T='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof n=="string"?t=n:(t=n.text,y="scalar"in n?n.scalar:y,T="fontFamily"in n?n.fontFamily:T,x="color"in n?n.color:x);var M=10*y,P=""+M+"px "+T,v=new OffscreenCanvas(M,M),A=v.getContext("2d");A.font=P;var E=A.measureText(t),O=Math.ceil(E.actualBoundingBoxRight+E.actualBoundingBoxLeft),R=Math.ceil(E.actualBoundingBoxAscent+E.actualBoundingBoxDescent),L=2,z=E.actualBoundingBoxLeft+L,I=E.actualBoundingBoxAscent+L;O+=L+L,R+=L+L,v=new OffscreenCanvas(O,R),A=v.getContext("2d"),A.font=P,A.fillStyle=x,A.fillText(t,z,I);var Q=1/y;return{type:"bitmap",bitmap:v.transferToImageBitmap(),matrix:[Q,0,0,Q,-O*Q/2,-R*Q/2]}}i.exports=function(){return se().apply(this,arguments)},i.exports.reset=function(){se().reset()},i.exports.create=ae,i.exports.shapeFromPath=ve,i.exports.shapeFromText=xe})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),re,!1);const Ee=re.exports;re.exports.create;function fe(k,e,i){try{Ee({particleCount:100,spread:70,origin:{y:.6}})}catch{}const{totalScore:o,recommendedTrack:a,flags:r,performanceIndicators:s}=i;let m="";r.length>0&&(m=r.map(b=>`
    ...
    `}).join(""),u=e.break_events||[];let S="";u.length>0?S=u.map(b=>{const C=Math.floor(b.breakDurationMs/6e4),B=Math.round(b.breakDurationMs%6e4/1e3),q=Math.round(b.countdownRemainingAtPause);return`
  ...
  `;const d=k.querySelector("#restart-btn");d&&d.addEventListener("click",()=>{window.location.reload()});const _=k.querySelector("#print-report-btn");_&&_.addEventListener("click",()=>window.print());const $=k.querySelector("#download-pdf-btn");$&&$.addEventListener("click",()=>Oe(e));const F=k.querySelector("#download-csv-btn");F&&F.addEventListener("click",()=>{Le(e)});const D=k.querySelector("#ceo-dashboard-btn");D&&D.addEventListener("click",()=>{be(k)})}function Re(k){try{const e=localStorage.getItem("cognix_all_sessions");let i=e?JSON.parse(e):[];i=i.filter(o=>o.session_id!==k.session_id),i.unshift(k),localStorage.setItem("cognix_all_sessions",JSON.stringify(i))}catch{}}function be(k){const e=localStorage.getItem("cognix_all_sessions"),i=e?JSON.parse(e):[];if(i.length===0){k.innerHTML=`
  ...
  `;const g=k.querySelector("#export-all-csv-btn");g&&g.addEventListener("click",()=>qe(i));const u=k.querySelector("#ceo-restart-btn");u&&u.addEventListener("click",()=>window.location.reload()),k.querySelectorAll(".view-session-btn").forEach(c=>{c.addEventListener("click",w=>{const l=w.currentTarget.getAttribute("data-id"),d=i.find(_=>_.session_id===l);if(d){const _={totalScore:d.total_score,placedTrack:d.placed_track||"Level 1",recommendedTrack:d.recommended_track||"Level 1",flags:Array.isArray(d.flags)?d.flags.map($=>typeof $=="string"?{title:$,description:"",type:"advisory"}:$):[],performanceIndicators:{overallAccuracy:d.total_score,adaptabilityIndex:.85,learningProgressVelocity:"Steady",hintDependencyRatio:.1}};fe(k,d,_)}})})}function qe(k){let e=`StudentName,AgeGroup,TotalScore,PlacedTrack,ActiveTimeMins,Timeouts,BreaksCount,FlagsCount,CompletedDate
...
`});const o=new Blob([i],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(o),r=document.createElement("a");r.setAttribute("href",a),r.setAttribute("download",`Cognix_CEO_Assessment_Time_Report_${k.student_name.replace(/\s+/g,"_")}.csv`),r.click()}function De(k){return k.replace(/^### (.*$)/gim,'<h3 style="color:var(--text-primary); font-size:1.05rem; margin-top:1rem; margin-bottom:0.4rem;">$1</h3>').replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/^> (.*$)/gim,'<blockquote style="border-left:3px solid var(--accent-cyan); padding-left:0.8rem; margin:0.8rem 0; color:var(--accent-cyan); font-size:0.9rem;">$1</blockquote>')}const j=class j{constructor(e){this.studentName="Alex Rivers",this.cachedActivities=new Array(60).fill(null),this.userAnswers=[],this.questionTimeRecords=[],this.breakEvents=[],this.currentQuestionIndex=0,this.totalTimerSeconds=0,this.questionTimerSecondsRemaining=j.QUESTION_TIME_LIMIT_SEC,this.itemStartTimestamp=0,this.itemFirstInteractionTimestamp=null,this.currentPauseStartTimestamp=null,this.pauseDurationForCurrentQuestionMs=0,this.isPaused=!1,this.globalTimerInterval=null,this.questionTimerInterval=null,this.loadGen=0,this.isLoadingNextQuestion=!1,this.motorTargetPos={top:80,left:240},this.beforeUnloadHandler=()=>{this.saveSession(this.studentName)},this.container=e,this.generator=new Ie,this.analyzer=new $e,this.initUserAnswers()}static getSavedSession(){try{const e=localStorage.getItem(j.STORAGE_KEY);if(!e)return null;const i=JSON.parse(e);return i&&Array.isArray(i.userAnswers)&&i.userAnswers.length===60?i:null}catch{return null}}static clearSavedSession(){try{localStorage.removeItem(j.STORAGE_KEY)}catch{}}saveSession(e=this.studentName){try{this.studentName=e;const i={studentName:e,currentQuestionIndex:this.currentQuestionIndex,totalTimerSeconds:this.totalTimerSeconds,currentQuestionRemainingSeconds:this.questionTimerSecondsRemaining,isPaused:this.isPaused,cachedActivities:this.cachedActivities,userAnswers:this.userAnswers,questionTimeRecords:this.questionTimeRecords,breakEvents:this.breakEvents,savedAt:Date.now()};localStorage.setItem(j.STORAGE_KEY,JSON.stringify(i))}catch{}}attachBeforeUnload(){window.removeEventListener("beforeunload",this.beforeUnloadHandler),window.addEventListener("beforeunload",this.beforeUnloadHandler)}detachBeforeUnload(){window.removeEventListener("beforeunload",this.beforeUnloadHandler)}initUserAnswers(){this.userAnswers=new Array(60).fill(null).map(()=>({selectedAnswerIndex:null,robotSequence:[],motorClicks:[],attemptsCount:0,hintsUsed:0,timeSpentMs:0,isSolved:!1,timedOut:!1,answeredAt:null,responseLatencyMs:null,remainingTimeWhenAnsweredMs:null,breaksDuringQuestion:0})),this.questionTimeRecords=[],this.breakEvents=[]}async startSession(e="Alex Rivers",i=!0){this.studentName=e;const o=i?j.getSavedSession():null;o?(this.currentQuestionIndex=Math.max(0,Math.min(59,o.currentQuestionIndex||0)),this.cachedActivities=o.cachedActivities||new Array(60).fill(null),this.userAnswers=o.userAnswers,this.questionTimeRecords=o.questionTimeRecords||[],this.breakEvents=o.breakEvents||[],this.totalTimerSeconds=o.totalTimerSeconds||0,this.questionTimerSecondsRemaining=o.currentQuestionRemainingSeconds||j.QUESTION_TIME_LIMIT_SEC,this.isPaused=o.isPaused||!1,this.startGlobalTimer(this.totalTimerSeconds),this.attachBeforeUnload(),this.isPaused?(await this.loadQuestion(this.currentQuestionIndex,!1),this.pauseAssessment()):await this.loadQuestion(this.currentQuestionIndex,!1)):(this.currentQuestionIndex=0,this.cachedActivities=new Array(60).fill(null),this.initUserAnswers(),this.totalTimerSeconds=0,this.questionTimerSecondsRemaining=j.QUESTION_TIME_LIMIT_SEC,this.isPaused=!1,this.startGlobalTimer(0),this.attachBeforeUnload(),this.saveSession(e),await this.loadQuestion(0,!0))}startGlobalTimer(e=0){this.totalTimerSeconds=e,this.globalTimerInterval&&clearInterval(this.globalTimerInterval),this.globalTimerInterval=setInterval(()=>{if(!this.isPaused){this.totalTimerSeconds++,this.totalTimerSeconds%3===0&&this.saveSession(this.studentName);const i=document.getElementById("global-timer");if(i){const o=String(Math.floor(this.totalTimerSeconds/60)).padStart(2,"0"),a=String(this.totalTimerSeconds%60).padStart(2,"0");i.textContent=`${o}:${a}`}}},1e3)}speakAudio(e){try{if("speechSynthesis"in window){window.speechSynthesis.cancel();const i=new SpeechSynthesisUtterance(e);i.rate=.9,i.pitch=1,window.speechSynthesis.speak(i)}}catch{}}startQuestionTimer(){this.questionTimerInterval&&(clearInterval(this.questionTimerInterval),this.questionTimerInterval=null),this.questionTimerInterval=setInterval(()=>{this.isPaused||(this.questionTimerSecondsRemaining--,this.updateQuestionTimerUI(),this.questionTimerSecondsRemaining<=0&&(clearInterval(this.questionTimerInterval),this.questionTimerInterval=null,this.handleQuestionTimeout()))},1e3)}updateQuestionTimerUI(){const e=document.getElementById("question-timer-display"),i=document.getElementById("question-timer-ring");if(e){const o=Math.floor(this.questionTimerSecondsRemaining/60),a=String(this.questionTimerSecondsRemaining%60).padStart(2,"0");e.textContent=`${o}:${a}`,this.questionTimerSecondsRemaining<=15?e.style.color="#ef4444":e.style.color="var(--accent-cyan)"}if(i){const o=this.questionTimerSecondsRemaining/j.QUESTION_TIME_LIMIT_SEC*100;i.style.width=`${o}%`}}async loadQuestion(e,i=!0){var s;if(e<0||e>=60)return;this.motorTargetPos={top:80,left:240};const o=++this.loadGen;this.currentQuestionIndex=e;const a=U[e];if(this.questionTimerInterval&&(clearInterval(this.questionTimerInterval),this.questionTimerInterval=null),i&&(this.questionTimerSecondsRemaining=j.QUESTION_TIME_LIMIT_SEC),this.itemFirstInteractionTimestamp=null,this.pauseDurationForCurrentQuestionMs=0,!this.cachedActivities[e]&&(this.renderLoadingState(e),this.cachedActivities[e]=await this.generator.generateActivity(a.slot),o!==this.loadGen))return;this.isLoadingNextQuestion=!1,this.itemStartTimestamp=Date.now(),this.saveSession(this.studentName),this.render();const r=this.cachedActivities[e];if(r&&r.type==="picture_match"){const m=((s=r.payload)==null?void 0:s.audioPromptText)||r.instructions;m&&this.speakAudio(m)}this.isPaused||this.startQuestionTimer(),this.prefetchNextQuestion(e+1)}renderLoadingState(e){const i=U[e],o=ee[i.domain],a=this.container.querySelector("#playground-area");a&&(a.innerHTML=`
            ...
            <div style="display:flex; align-items:center; gap:0.75rem;">
              ...
              <div style="display:flex; align-items:center; gap:0.5rem; background:rgba(15,23,42,0.8); border:1px solid var(--border-color); padding:0.4rem 0.9rem; border-radius:20px;">
                ...
                <div style="width:48px; height:5px; background:rgba(255,255,255,0.1); border-radius:3px; overflow:hidden;">
                  <div id="question-timer-ring" style="width:${this.questionTimerSecondsRemaining/j.QUESTION_TIME_LIMIT_SEC*100}%; height:100%; background:${this.questionTimerSecondsRemaining<=15?"#ef4444":"var(--accent-cyan)"}; transition:width 0.9s linear;"></div>
                </div>
              </div>
              <!-- Pause Button -->
    ...
    `,this.attachEventListeners()}renderPlaygroundContent(e,i){const o=e.payload||{};if(e.type==="robot_mission"||Array.isArray(o.availableBlocks))return`
