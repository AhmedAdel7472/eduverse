...
`,s=await this.client.generateCompletion(n,"You are an expert educational psychologist and SEN assessment specialist. Provide concise, professional diagnostic summaries.");return s||this.getBuiltInReport(e,o)}getBuiltInReport(e,o){const{totalScore:n,recommendedTrack:s,performanceIndicators:r,flags:a}=o;let l=`### Executive Assessment Summary
`;return l+=`**${e.student_name}** completed the AI Digital Placement Assessment, achieving a **Technology Readiness Score of ${n}/100**, placing into the **${s}** track.
...
`,l+=`During the dynamic rule-switch challenges, the student achieved an Adaptability Index of **${r.adaptabilityIndex}**, displaying a **${r.learningProgressVelocity}** learning progress velocity across progressive difficulty levels. `,a.length>0?l+=`

> [!NOTE]
> **Targeted Support Areas Identified**: ${a.map(m=>m.title).join(" • ")}. Targeted practice modules are recommended to solidify these core competencies.`:l+=`

> [!TIP]
> **Strengths Spotlight**: Well-rounded mastery observed across all five competency domains. Prepared for direct engagement with advanced robotics and interactive programming modules.`,l}}var re={};(function $(e,o,n,s){var r=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),a=typeof Path2D=="function"&&typeof DOMMatrix=="function",l=(function(){if(!e.OffscreenCanvas)return!1;try{var i=new OffscreenCanvas(1,1),t=i.getContext("2d");t.fillRect(0,0,1,1);var u=i.transferToImageBitmap();t.createPattern(u,"no-repeat")}catch{return!1}return!0})();function m(){}function k(i){var t=o.exports.Promise,u=t!==void 0?t:e.Promise;return typeof u=="function"?new u(i):(i(m,m),null)}var M=(function(i,t){return{transform:function(u){if(i)return u;if(t.has(u))return t.get(u);var h=new OffscreenCanvas(u.width,u.height),f=h.getContext("2d");return f.drawImage(u,0,0),t.set(u,h),h},clear:function(){t.clear()}}})(l,new Map),v=(function(){var i=Math.floor(16.666666666666668),t,u,h={},f=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(t=function(b){var x=Math.random();return h[x]=requestAnimationFrame(function p(S){f===S||f+i-1<S?(f=S,delete h[x],b()):h[x]=requestAnimationFrame(p)}),x},u=function(b){h[b]&&cancelAnimationFrame(h[b])}):(t=function(b){return setTimeout(b,i)},u=function(b){return clearTimeout(b)}),{frame:t,cancel:u}})(),T=(function(){var i,t,u={};function h(f){function b(x,p){f.postMessage({options:x||{},callback:p})}f.init=function(p){var S=p.transferControlToOffscreen();f.postMessage({canvas:S},[S])},f.fire=function(p,S,A){if(t)return b(p,null),t;var R=Math.random().toString(36).slice(2);return t=k(function(E){function q(Q){Q.data.callback===R&&(delete u[R],f.removeEventListener("message",q),t=null,M.clear(),A(),E())}f.addEventListener("message",q),b(p,R),u[R]=q.bind(null,{data:{callback:R}})}),t},f.reset=function(){f.postMessage({reset:!0});for(var p in u)u[p](),delete u[p]}}return function(){if(i)return i;if(!n&&r){var f=["var CONFETTI, SIZE = {}, module = {};","("+$.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{i=new Worker(URL.createObjectURL(new Blob([f])))}catch(b){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",b),null}h(i)}return i}})(),y={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function P(i,t){return t?t(i):i}function _(i){return i!=null}function c(i,t,u){return P(i&&_(i[t])?i[t]:y[t],u)}function g(i){return i<0?0:Math.floor(i)}function O(i,t){return Math.floor(Math.random()*(t-i))+i}function B(i){return parseInt(i,16)}function D(i){return i.map(d)}function d(i){var t=String(i).replace(/[^0-9a-f]/gi,"");return t.length<6&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),{r:B(t.substring(0,2)),g:B(t.substring(2,4)),b:B(t.substring(4,6))}}function L(i){var t=c(i,"origin",Object);return t.x=c(t,"x",Number),t.y=c(t,"y",Number),t}function I(i){i.width=document.documentElement.clientWidth,i.height=document.documentElement.clientHeight}function F(i){var t=i.getBoundingClientRect();i.width=t.width,i.height=t.height}function C(i){var t=document.createElement("canvas");return t.style.position="fixed",t.style.top="0px",t.style.left="0px",t.style.pointerEvents="none",t.style.zIndex=i,t}function j(i,t,u,h,f,b,x,p,S){i.save(),i.translate(t,u),i.rotate(b),i.scale(h,f),i.arc(0,0,1,x,p,S),i.restore()}function Y(i){var t=i.angle*(Math.PI/180),u=i.spread*(Math.PI/180);return{x:i.x,y:i.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:i.startVelocity*.5+Math.random()*i.startVelocity,angle2D:-t+(.5*u-Math.random()*u),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:i.color,shape:i.shape,tick:0,totalTicks:i.ticks,decay:i.decay,drift:i.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:i.gravity*3,ovalScalar:.6,scalar:i.scalar,flat:i.flat}}function J(i,t){t.x+=Math.cos(t.angle2D)*t.velocity+t.drift,t.y+=Math.sin(t.angle2D)*t.velocity+t.gravity,t.velocity*=t.decay,t.flat?(t.wobble=0,t.wobbleX=t.x+10*t.scalar,t.wobbleY=t.y+10*t.scalar,t.tiltSin=0,t.tiltCos=0,t.random=1):(t.wobble+=t.wobbleSpeed,t.wobbleX=t.x+10*t.scalar*Math.cos(t.wobble),t.wobbleY=t.y+10*t.scalar*Math.sin(t.wobble),t.tiltAngle+=.1,t.tiltSin=Math.sin(t.tiltAngle),t.tiltCos=Math.cos(t.tiltAngle),t.random=Math.random()+2);var u=t.tick++/t.totalTicks,h=t.x+t.random*t.tiltCos,f=t.y+t.random*t.tiltSin,b=t.wobbleX+t.random*t.tiltCos,x=t.wobbleY+t.random*t.tiltSin;if(i.fillStyle="rgba("+t.color.r+", "+t.color.g+", "+t.color.b+", "+(1-u)+")",i.beginPath(),a&&t.shape.type==="path"&&typeof t.shape.path=="string"&&Array.isArray(t.shape.matrix))i.fill(he(t.shape.path,t.shape.matrix,t.x,t.y,Math.abs(b-h)*.1,Math.abs(x-f)*.1,Math.PI/10*t.wobble));else if(t.shape.type==="bitmap"){var p=Math.PI/10*t.wobble,S=Math.abs(b-h)*.1,A=Math.abs(x-f)*.1,R=t.shape.bitmap.width*t.scalar,E=t.shape.bitmap.height*t.scalar,q=new DOMMatrix([Math.cos(p)*S,Math.sin(p)*S,-Math.sin(p)*A,Math.cos(p)*A,t.x,t.y]);q.multiplySelf(new DOMMatrix(t.shape.matrix));var Q=i.createPattern(M.transform(t.shape.bitmap),"no-repeat");Q.setTransform(q),i.globalAlpha=1-u,i.fillStyle=Q,i.fillRect(t.x-R/2,t.y-E/2,R,E),i.globalAlpha=1}else if(t.shape==="circle")i.ellipse?i.ellipse(t.x,t.y,Math.abs(b-h)*t.ovalScalar,Math.abs(x-f)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI):j(i,t.x,t.y,Math.abs(b-h)*t.ovalScalar,Math.abs(x-f)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI);else if(t.shape==="star")for(var w=Math.PI/2*3,N=4*t.scalar,U=8*t.scalar,W=t.x,V=t.y,K=5,G=Math.PI/K;K--;)W=t.x+Math.cos(w)*U,V=t.y+Math.sin(w)*U,i.lineTo(W,V),w+=G,W=t.x+Math.cos(w)*N,V=t.y+Math.sin(w)*N,i.lineTo(W,V),w+=G;else i.moveTo(Math.floor(t.x),Math.floor(t.y)),i.lineTo(Math.floor(t.wobbleX),Math.floor(f)),i.lineTo(Math.floor(b),Math.floor(x)),i.lineTo(Math.floor(h),Math.floor(t.wobbleY));return i.closePath(),i.fill(),t.tick<t.totalTicks}function Z(i,t,u,h,f){var b=t.slice(),x=i.getContext("2d"),p,S,A=k(function(R){function E(){p=S=null,x.clearRect(0,0,h.width,h.height),M.clear(),f(),R()}function q(){n&&!(h.width===s.width&&h.height===s.height)&&(h.width=i.width=s.width,h.height=i.height=s.height),!h.width&&!h.height&&(u(i),h.width=i.width,h.height=i.height),x.clearRect(0,0,h.width,h.height),b=b.filter(function(Q){return J(x,Q)}),b.length?p=v.frame(q):E()}p=v.frame(q),S=E});return{addFettis:function(R){return b=b.concat(R),A},canvas:i,promise:A,reset:function(){p&&v.cancel(p),S&&S()}}}function ae(i,t){var u=!i,h=!!c(t||{},"resize"),f=!1,b=c(t,"disableForReducedMotion",Boolean),x=r&&!!c(t||{},"useWorker"),p=x?T():null,S=u?I:F,A=i&&p?!!i.__confetti_initialized:!1,R=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,E;function q(w,N,U){for(var W=c(w,"particleCount",g),V=c(w,"angle",Number),K=c(w,"spread",Number),G=c(w,"startVelocity",Number),ye=c(w,"decay",Number),be=c(w,"gravity",Number),ve=c(w,"drift",Number),le=c(w,"colors",D),xe=c(w,"ticks",Number),ce=c(w,"shapes"),Se=c(w,"scalar"),ke=!!c(w,"flat"),de=L(w),me=W,ie=[],_e=i.width*de.x,we=i.height*de.y;me--;)ie.push(Y({x:_e,y:we,angle:V,spread:K,startVelocity:G,color:le[me%le.length],shape:ce[O(0,ce.length)],ticks:xe,decay:ye,gravity:be,drift:ve,scalar:Se,flat:ke}));return E?E.addFettis(ie):(E=Z(i,ie,S,N,U),E.promise)}function Q(w){var N=b||c(w,"disableForReducedMotion",Boolean),U=c(w,"zIndex",Number);if(N&&R)return k(function(G){G()});u&&E?i=E.canvas:u&&!i&&(i=C(U),document.body.appendChild(i)),h&&!A&&S(i);var W={width:i.width,height:i.height};p&&!A&&p.init(i),A=!0,p&&(i.__confetti_initialized=!0);function V(){if(p){var G={getBoundingClientRect:function(){if(!u)return i.getBoundingClientRect()}};S(G),p.postMessage({resize:{width:G.width,height:G.height}});return}W.width=W.height=null}function K(){E=null,h&&(f=!1,e.removeEventListener("resize",V)),u&&i&&(document.body.contains(i)&&document.body.removeChild(i),i=null,A=!1)}return h&&!f&&(f=!0,e.addEventListener("resize",V,!1)),p?p.fire(w,W,K):q(w,W,K)}return Q.reset=function(){p&&p.reset(),E&&E.reset()},Q}var te;function se(){return te||(te=ae(null,{useWorker:!0,resize:!0})),te}function he(i,t,u,h,f,b,x){var p=new Path2D(i),S=new Path2D;S.addPath(p,new DOMMatrix(t));var A=new Path2D;return A.addPath(S,new DOMMatrix([Math.cos(x)*f,Math.sin(x)*f,-Math.sin(x)*b,Math.cos(x)*b,u,h])),A}function ge(i){if(!a)throw new Error("path confetti are not supported in this browser");var t,u;typeof i=="string"?t=i:(t=i.path,u=i.matrix);var h=new Path2D(t),f=document.createElement("canvas"),b=f.getContext("2d");if(!u){for(var x=1e3,p=x,S=x,A=0,R=0,E,q,Q=0;Q<x;Q+=2)for(var w=0;w<x;w+=2)b.isPointInPath(h,Q,w,"nonzero")&&(p=Math.min(p,Q),S=Math.min(S,w),A=Math.max(A,Q),R=Math.max(R,w));E=A-p,q=R-S;var N=10,U=Math.min(N/E,N/q);u=[U,0,0,U,-Math.round(E/2+p)*U,-Math.round(q/2+S)*U]}return{type:"path",path:t,matrix:u}}function fe(i){var t,u=1,h="#000000",f='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof i=="string"?t=i:(t=i.text,u="scalar"in i?i.scalar:u,f="fontFamily"in i?i.fontFamily:f,h="color"in i?i.color:h);var b=10*u,x=""+b+"px "+f,p=new OffscreenCanvas(b,b),S=p.getContext("2d");S.font=x;var A=S.measureText(t),R=Math.ceil(A.actualBoundingBoxRight+A.actualBoundingBoxLeft),E=Math.ceil(A.actualBoundingBoxAscent+A.actualBoundingBoxDescent),q=2,Q=A.actualBoundingBoxLeft+q,w=A.actualBoundingBoxAscent+q;R+=q+q,E+=q+q,p=new OffscreenCanvas(R,E),S=p.getContext("2d"),S.font=x,S.fillStyle=h,S.fillText(t,Q,w);var N=1/u;return{type:"bitmap",bitmap:p.transferToImageBitmap(),matrix:[N,0,0,N,-R*N/2,-E*N/2]}}o.exports=function(){return se().apply(this,arguments)},o.exports.reset=function(){se().reset()},o.exports.create=ae,o.exports.shapeFromPath=ge,o.exports.shapeFromText=fe})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),re,!1);const Ie=re.exports;re.exports.create;function Ae($,e,o){try{Ie({particleCount:100,spread:70,origin:{y:.6}})}catch{}const{totalScore:n,recommendedTrack:s,flags:r,performanceIndicators:a}=o;let l="";r.length>0&&(l=r.map(d=>`
    ...
    `}).join(""),k=e.question_time_records||[],M=k.map(d=>{if(!d)return"";const L=Math.round(d.activeDurationMs/1e3),I=d.responseLatencyMs?(d.responseLatencyMs/1e3).toFixed(1)+"s":"—",F=d.remainingTimeWhenAnsweredMs?Math.round(d.remainingTimeWhenAnsweredMs/1e3)+"s":"0s";let C='<span style="color:#10b981; font-weight:700;">🟢 Fast</span>';return d.timedOut?C='<span style="color:#ef4444; font-weight:700;">⏰ Timed Out</span>':L>80?C='<span style="color:#f59e0b; font-weight:700;">🔴 Slow</span>':L>45&&(C='<span style="color:#3b82f6; font-weight:700;">🟡 Normal</span>'),`
      <tr style="${d.timedOut?"background:rgba(239,68,68,0.08);":""} border-bottom:1px solid rgba(255,255,255,0.05); font-size:0.85rem;">
        ...
        <td style="padding:0.6rem 0.8rem; text-align:center;">${F}</td>
    ...
    `}).join(""),v=e.break_events||[];let T="";v.length>0?T=v.map(d=>{const L=Math.floor(d.breakDurationMs/6e4),I=Math.round(d.breakDurationMs%6e4/1e3),F=Math.round(d.countdownRemainingAtPause);return`
        <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.04); border:1px solid var(--border-color); padding:0.75rem 1rem; border-radius:10px; margin-bottom:0.5rem; font-size:0.88rem;">
          ...
          <div style="color:var(--accent-amber); font-weight:700;">
            Duration: ${L>0?`${L}m `:""}${I}s (Timer left: ${F}s)
          </div>
        </div>
      `}).join(""):T=`
    ...
    `;const y=Math.round((e.total_active_duration_ms||0)/6e4),P=Math.round((e.total_break_duration_ms||0)/6e4),_=Math.round((e.total_wall_clock_duration_ms||0)/6e4),c=k.filter(d=>d==null?void 0:d.timedOut).length;$.innerHTML=`
    <div class="glass-card" style="padding: 2.5rem; max-width:1150px; margin:0 auto;">
        ...
        <div class="placement-badge-card">
          ...
          <div style="margin-top: 1.5rem; width: 100%; border-top: 1px solid var(--border-color); padding-top: 1rem; text-align: left; font-size: 0.85rem; color: var(--text-secondary);">
            <div style="display:flex; justify-content:space-between; margin-bottom:0.4rem;">
              <span>Accuracy:</span> <strong>${a.overallAccuracy}%</strong>
            </div>
            <div style="display:flex; justify-content:space-between; margin-bottom:0.4rem;">
      ...
      <div style="margin-top: 2.5rem; border-top: 1px solid var(--border-color); padding-top: 2rem;">
        ...
        <div style="margin-top: 2rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.5rem;" class="summary-md">
          ${e.qualitative_summary?$e(e.qualitative_summary):""}
        </div>
      </div>
  ...
  `;const g=$.querySelector("#restart-btn");g&&g.addEventListener("click",()=>{window.location.reload()});const O=$.querySelector("#print-report-btn");O&&O.addEventListener("click",()=>window.print());const B=$.querySelector("#download-pdf-btn");B&&B.addEventListener("click",()=>Ce(e));const D=$.querySelector("#download-csv-btn");D&&D.addEventListener("click",()=>{Ee(e)})}function Ce($){document.body.classList.add("printing-report");const e=document.createElement("style");e.id="cognix-print-style",e.innerHTML=`
    @media print {
  ...
  `,document.head.appendChild(e);const o=document.title;document.title=`Cognix_Report_${$.student_name.replace(/\s+/g,"_")}_${new Date().toISOString().split("T")[0]}`,window.print(),setTimeout(()=>{document.body.classList.remove("printing-report");const n=document.getElementById("cognix-print-style");n&&n.remove(),document.title=o},2e3)}function Ee($){const e=$.question_time_records||[];let o=`Slot,Domain,SubSkill,QuestionTitle,ActiveTimeSec,ResponseLatencySec,TimerRemainingSec,Status,TimedOut,Breaks,EarnedPoints,MaxPoints
`;e.forEach(a=>{if(!a)return;const l=(a.activeDurationMs/1e3).toFixed(1),m=a.responseLatencyMs?(a.responseLatencyMs/1e3).toFixed(1):"",k=a.remainingTimeWhenAnsweredMs?(a.remainingTimeWhenAnsweredMs/1e3).toFixed(1):"0",M=a.timedOut?"TIMED_OUT":a.activeDurationMs>8e4?"SLOW":a.activeDurationMs>45e3?"NORMAL":"FAST";o+=`${a.questionSlot},"${a.domain}","${a.subSkill}","${a.questionTitle.replace(/"/g,'""')}",${l},${m},${k},${M},${a.timedOut},${a.breaksDuringQuestion},${a.earnedScore},${a.maxScore}
`});const n=new Blob([o],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(n),r=document.createElement("a");r.setAttribute("href",s),r.setAttribute("download",`Cognix_CEO_Assessment_Time_Report_${$.student_name.replace(/\s+/g,"_")}.csv`),r.click()}function $e($){return $.replace(/^### (.*$)/gim,'<h3 style="color:var(--text-primary); font-size:1.05rem; margin-top:1rem; margin-bottom:0.4rem;">$1</h3>').replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/^> (.*$)/gim,'<blockquote style="border-left:3px solid var(--accent-cyan); padding-left:0.8rem; margin:0.8rem 0; color:var(--accent-cyan); font-size:0.9rem;">$1</blockquote>')}const z=class z{constructor(e){this.studentName="Alex Rivers",this.cachedActivities=new Array(60).fill(null),this.userAnswers=[],this.questionTimeRecords=[],this.breakEvents=[],this.currentQuestionIndex=0,this.totalTimerSeconds=0,this.questionTimerSecondsRemaining=z.QUESTION_TIME_LIMIT_SEC,this.itemStartTimestamp=0,this.itemFirstInteractionTimestamp=null,this.currentPauseStartTimestamp=null,this.pauseDurationForCurrentQuestionMs=0,this.isPaused=!1,this.globalTimerInterval=null,this.questionTimerInterval=null,this.beforeUnloadHandler=()=>{this.saveSession(this.studentName)},this.container=e,this.generator=new Te,this.analyzer=new Pe,this.initUserAnswers()}static getSavedSession(){try{const e=localStorage.getItem(z.STORAGE_KEY);if(!e)return null;const o=JSON.parse(e);return o&&Array.isArray(o.userAnswers)&&o.userAnswers.length===60?o:null}catch{return null}}static clearSavedSession(){try{localStorage.removeItem(z.STORAGE_KEY)}catch{}}saveSession(e=this.studentName){try{this.studentName=e;const o={studentName:e,currentQuestionIndex:this.currentQuestionIndex,totalTimerSeconds:this.totalTimerSeconds,currentQuestionRemainingSeconds:this.questionTimerSecondsRemaining,isPaused:this.isPaused,cachedActivities:this.cachedActivities,userAnswers:this.userAnswers,questionTimeRecords:this.questionTimeRecords,breakEvents:this.breakEvents,savedAt:Date.now()};localStorage.setItem(z.STORAGE_KEY,JSON.stringify(o))}catch{}}attachBeforeUnload(){window.removeEventListener("beforeunload",this.beforeUnloadHandler),window.addEventListener("beforeunload",this.beforeUnloadHandler)}detachBeforeUnload(){window.removeEventListener("beforeunload",this.beforeUnloadHandler)}initUserAnswers(){this.userAnswers=new Array(60).fill(null).map(()=>({selectedAnswerIndex:null,robotSequence:[],motorClicks:[],attemptsCount:0,hintsUsed:0,timeSpentMs:0,isSolved:!1,timedOut:!1,answeredAt:null,responseLatencyMs:null,remainingTimeWhenAnsweredMs:null,breaksDuringQuestion:0})),this.questionTimeRecords=[],this.breakEvents=[]}async startSession(e="Alex Rivers",o=!0){this.studentName=e;const n=o?z.getSavedSession():null;n?(this.currentQuestionIndex=Math.max(0,Math.min(59,n.currentQuestionIndex||0)),this.cachedActivities=n.cachedActivities||new Array(60).fill(null),this.userAnswers=n.userAnswers,this.questionTimeRecords=n.questionTimeRecords||[],this.breakEvents=n.breakEvents||[],this.totalTimerSeconds=n.totalTimerSeconds||0,this.questionTimerSecondsRemaining=n.currentQuestionRemainingSeconds||z.QUESTION_TIME_LIMIT_SEC,this.isPaused=n.isPaused||!1,this.startGlobalTimer(this.totalTimerSeconds),this.attachBeforeUnload(),this.isPaused?(await this.loadQuestion(this.currentQuestionIndex,!1),this.pauseAssessment()):await this.loadQuestion(this.currentQuestionIndex,!1)):(this.currentQuestionIndex=0,this.cachedActivities=new Array(60).fill(null),this.initUserAnswers(),this.totalTimerSeconds=0,this.questionTimerSecondsRemaining=z.QUESTION_TIME_LIMIT_SEC,this.isPaused=!1,this.startGlobalTimer(0),this.attachBeforeUnload(),this.saveSession(e),await this.loadQuestion(0,!0))}startGlobalTimer(e=0){this.totalTimerSeconds=e,this.globalTimerInterval&&clearInterval(this.globalTimerInterval),this.globalTimerInterval=setInterval(()=>{if(!this.isPaused){this.totalTimerSeconds++,this.totalTimerSeconds%3===0&&this.saveSession(this.studentName);const o=document.getElementById("global-timer");if(o){const n=String(Math.floor(this.totalTimerSeconds/60)).padStart(2,"0"),s=String(this.totalTimerSeconds%60).padStart(2,"0");o.textContent=`${n}:${s}`}}},1e3)}startQuestionTimer(){this.questionTimerInterval&&clearInterval(this.questionTimerInterval),this.questionTimerInterval=setInterval(()=>{this.isPaused||(this.questionTimerSecondsRemaining--,this.updateQuestionTimerUI(),this.questionTimerSecondsRemaining<=0&&(clearInterval(this.questionTimerInterval),this.handleQuestionTimeout()))},1e3)}updateQuestionTimerUI(){const e=document.getElementById("question-timer-display"),o=document.getElementById("question-timer-ring");if(e){const n=Math.floor(this.questionTimerSecondsRemaining/60),s=String(this.questionTimerSecondsRemaining%60).padStart(2,"0");e.textContent=`${n}:${s}`,this.questionTimerSecondsRemaining<=15?e.style.color="#ef4444":e.style.color="var(--accent-cyan)"}if(o){const n=this.questionTimerSecondsRemaining/z.QUESTION_TIME_LIMIT_SEC*100;o.style.width=`${n}%`}}async loadQuestion(e,o=!0){if(e<0||e>=60)return;this.currentQuestionIndex=e;const n=H[e];this.questionTimerInterval&&clearInterval(this.questionTimerInterval),o&&(this.questionTimerSecondsRemaining=z.QUESTION_TIME_LIMIT_SEC),this.itemFirstInteractionTimestamp=null,this.pauseDurationForCurrentQuestionMs=0,this.cachedActivities[e]||(this.renderLoadingState(e),this.cachedActivities[e]=await this.generator.generateActivity(n.slot)),this.itemStartTimestamp=Date.now(),this.saveSession(this.studentName),this.render(),this.isPaused||this.startQuestionTimer(),this.prefetchNextQuestion(e+1)}renderLoadingState(e){const o=H[e],n=ee[o.domain],s=this.container.querySelector("#playground-area");s&&(s.innerHTML=`
      ...
      `)}async prefetchNextQuestion(e){if(e>=0&&e<60&&!this.cachedActivities[e]){const o=H[e];this.generator.generateActivity(o.slot).then(n=>{this.cachedActivities[e]=n}).catch(()=>{})}}pauseAssessment(){if(this.isPaused)return;this.isPaused=!0,this.currentPauseStartTimestamp=Date.now();const e=this.userAnswers[this.currentQuestionIndex];e&&e.breaksDuringQuestion++;const o=document.getElementById("pause-overlay");o&&(o.style.display="flex"),this.saveSession(this.studentName)}resumeAssessment(){if(!this.isPaused)return;const e=Date.now();if(this.currentPauseStartTimestamp){const n=e-this.currentPauseStartTimestamp;this.pauseDurationForCurrentQuestionMs+=n;const s=H[this.currentQuestionIndex];this.breakEvents.push({breakIndex:this.breakEvents.length+1,questionSlotAtPause:this.currentQuestionIndex+1,domainAtPause:s.domain,pauseStartTimestamp:this.currentPauseStartTimestamp,resumeTimestamp:e,breakDurationMs:n,countdownRemainingAtPause:this.questionTimerSecondsRemaining})}this.isPaused=!1,this.currentPauseStartTimestamp=null;const o=document.getElementById("pause-overlay");o&&(o.style.display="none"),this.startQuestionTimer(),this.saveSession(this.studentName)}handleQuestionTimeout(){const e=this.userAnswers[this.currentQuestionIndex];e.timedOut=!0,e.isSolved=!1,this.recordQuestionTimeData(!1),this.advanceToNextQuestion()}recordQuestionTimeData(e){const o=Date.now(),n=this.userAnswers[this.currentQuestionIndex],s=H[this.currentQuestionIndex],r=this.cachedActivities[this.currentQuestionIndex],a=o-this.itemStartTimestamp,l=Math.max(1e3,a-this.pauseDurationForCurrentQuestionMs);n.timeSpentMs+=l;const m={questionSlot:s.slot,domain:s.domain,subSkill:s.subSkill,questionTitle:(r==null?void 0:r.title)||s.title,questionStartTimestamp:this.itemStartTimestamp,questionEndTimestamp:o,totalDurationMs:a,pausedDurationMs:this.pauseDurationForCurrentQuestionMs,activeDurationMs:l,responseLatencyMs:n.responseLatencyMs,answeredAt:n.answeredAt,timedOut:n.timedOut,wasAnswered:e,remainingTimeWhenAnsweredMs:n.remainingTimeWhenAnsweredMs,breaksDuringQuestion:n.breaksDuringQuestion,earnedScore:0,maxScore:s.maxPoints};this.questionTimeRecords[this.currentQuestionIndex]=m}advanceToNextQuestion(){if(this.questionTimerInterval&&clearInterval(this.questionTimerInterval),this.currentQuestionIndex<59){const e=H[this.currentQuestionIndex].domain,o=H[this.currentQuestionIndex+1].domain;e!==o?this.showDomainTransitionBanner(o,()=>{this.loadQuestion(this.currentQuestionIndex+1,!0)}):this.loadQuestion(this.currentQuestionIndex+1,!0)}else this.completeAssessment()}showDomainTransitionBanner(e,o){const n=ee[e],s=this.container.querySelector("#playground-area");s&&(s.innerHTML=`
      ...
      `),setTimeout(o,2200)}render(){const e=this.cachedActivities[this.currentQuestionIndex];if(!e)return;const o=H[this.currentQuestionIndex],n=ee[o.domain],s=this.userAnswers[this.currentQuestionIndex],r=this.currentQuestionIndex>0?this.currentQuestionIndex-1:-1;let a=`
    ...
    `;for(let l=0;l<60;l++){const m=l===this.currentQuestionIndex,k=this.userAnswers[l].isSolved,M=this.userAnswers[l].timedOut,v=l<this.currentQuestionIndex,T=l===r;let y="lily-pad";m?y+=" active-pad frog-land":k?y+=" solved-pad":M?y+=" timed-out-pad":T?y+=" just-left-pad":v?y+=" past-pad":y+=" locked-pad";let P=`${l+1}`;m?P="🐸":k?P="✓":M&&(P="⏰"),a+=`
        <div class="${y}" title="Q${l+1}">${P}</div>
      `}a+="</div></div>",this.container.innerHTML=`
      ${a}
      ...
      <div class="glass-card activity-card">
        ...
        <div class="interactive-playground" id="playground-area">
          ${this.renderPlaygroundContent(e,s)}
        </div>
    ...
    `,this.attachEventListeners()}renderPlaygroundContent(e,o){const n=e.payload||{};if(e.type==="robot_mission"||Array.isArray(n.availableBlocks))return`
      ...
      `;if(e.type==="picture_match"){const a=n.audioPromptText||e.instructions||"Select the matching item",l=n.options&&n.options.length>0?n.options:[{label:"Option A",emoji:"🤖"},{label:"Option B",emoji:"🍎"},{label:"Option C",emoji:"⚽"}];return`
      ...
      `}if(e.type==="motor_target"){const a=n.targetsCount||3,l=o.motorClicks.length>=a;return`
        <div class="motor-canvas-container" id="motor-canvas">
          ...
          <div style="position:absolute; bottom:10px; left:15px; font-size:0.85rem; color:var(--text-secondary);">
            Targets Clicked: ${o.motorClicks.length} / ${a}
            ${l?" ✅ All targets hit!":""}
          </div>
        </div>
      `}const s=Array.isArray(n.options)&&n.options.length>0?n.options.slice(0,3):[{label:"Choice A"},{label:"Choice B"},{label:"Choice C"}],r=Array.isArray(n.sequence)?n.sequence:null;return`
      ${r?`
    ...
    `}async completeAssessment(){var T,y,P,_;this.globalTimerInterval&&clearInterval(this.globalTimerInterval),this.questionTimerInterval&&clearInterval(this.questionTimerInterval),this.detachBeforeUnload(),z.clearSavedSession(),this.showCompletionLoadingScreen();const e=[],o={};for(let c=0;c<60;c++){const g=this.cachedActivities[c],O=this.userAnswers[c],B=H[c];if(!g)continue;let D=!1,d=0;if(g.type==="robot_mission"||Array.isArray((T=g.payload)==null?void 0:T.availableBlocks)){const L=((y=g.payload)==null?void 0:y.correctSequence)||[];let I=0;O.robotSequence.forEach((F,C)=>{L[C]===F&&I++}),d=L.length>0?I/L.length:O.robotSequence.length>0?1:0,D=d>=.8}else g.type==="motor_target"?(D=O.motorClicks.length>0,d=Math.min(1,O.motorClicks.length/(((P=g.payload)==null?void 0:P.targetsCount)||3))):(D=O.selectedAnswerIndex===(((_=g.payload)==null?void 0:_.correctIndex)??0),d=D?1:0);o[g.id]=B.maxPoints,e.push({item_id:g.id,domain:g.domain,skill:g.skill,difficulty_level:g.difficulty,is_correct:D,accuracy_score:d,response_time_ms:Math.max(1e3,O.timeSpentMs),expected_time_ms:9e4,attempts_count:Math.max(1,O.attemptsCount),hints_used:O.hintsUsed}),this.questionTimeRecords[c]&&(this.questionTimeRecords[c].earnedScore=ne.calculateItemScore(e[c],B.maxPoints))}const n=ne.calculateDomainScores(e,o),s=ne.calculateTotalScore(n),r=Me.evaluatePlacement(s,n,e),a=["cognitive_ability","functional_skills","communication_level","behavioral_readiness","fine_motor_technology"],l={};a.forEach(c=>{const g=this.questionTimeRecords.filter(I=>I&&I.domain===c),O=g.reduce((I,F)=>I+(F.activeDurationMs||0),0),B=g.reduce((I,F)=>I+(F.pausedDurationMs||0),0),D=g.filter(I=>I.timedOut).length,d=g.map(I=>I.responseLatencyMs).filter(I=>I!==null),L=d.length>0?Math.round(d.reduce((I,F)=>I+F,0)/d.length):0;l[c]={totalActiveMs:O,totalPausedMs:B,questionsTimedOut:D,avgResponseLatencyMs:L}});const m=this.questionTimeRecords.reduce((c,g)=>c+((g==null?void 0:g.activeDurationMs)||0),0),k=this.breakEvents.reduce((c,g)=>c+g.breakDurationMs,0),M={session_id:`sess_60_${Date.now()}`,student_name:this.studentName||"Alex Rivers",age_group:"7-9",start_time:new Date(Date.now()-this.totalTimerSeconds*1e3).toISOString(),end_time:new Date().toISOString(),item_telemetries:e,domain_scores:n,total_score:s,placed_track:r.baseTrack,recommended_track:r.recommendedTrack,flags:r.flags.map(c=>c.id),question_time_records:this.questionTimeRecords,break_events:this.breakEvents,total_breaks_count:this.breakEvents.length,total_break_duration_ms:k,total_active_duration_ms:m,total_wall_clock_duration_ms:m+k,domain_time_summary:l},v=await this.analyzer.generateReportSummary(M,r);M.qualitative_summary=v,Ae(this.container,M,r)}};z.STORAGE_KEY="cognix_active_assessment_session",z.QUESTION_TIME_LIMIT_SEC=90;let X=z,ue=null;function oe($="Alex Rivers",e=!0){const o=document.getElementById("app");o&&(ue=new X(o),ue.startSession($,e))}function Re(){X.clearSavedSession()}window.initAssessment=oe;window.exitAssessment=Re;document.addEventListener("DOMContentLoaded",()=>{const $=document.getElementById("app"),e=document.getElementById("childTestPage"),o=X.getSavedSession();o&&e?(document.body.classList.add("exam-mode"),e.classList.remove("hidden"),e.classList.add("exam-active"),window.scrollTo(0,0),oe(o.studentName||"Alex Rivers",!0)):$&&!e&&oe("Alex Rivers",!1)});
